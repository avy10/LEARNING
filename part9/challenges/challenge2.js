...
// const goalScoringPlayers = Object.entries(game.scored);
// console.log(goalScoringPlayers)

for(let [i, playerName] of game.scored.entries()){
    console.log(`Goal ${++i} : ${playerName}`);
}

let avgSum = 0;
for(const keys of Object.values(game.odds)){
    avgSum += keys;
}
...
for(const gscored of game.scored){
